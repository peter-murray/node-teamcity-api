...
TeamCityAPI.prototype.createBuildConfiguration = function (locator, buildName) {
  ...
  if (locator && (locator.id == ROOT_PROJECT_LOCATOR.id || locator.name == "Root project")) {
...
TeamCityAPI.prototype.deleteBuildConfiguration = function(locator) {
  var self = this
    , request = self._request
    ;

  return request.execute(buildConfigurationEndpoints.deleteBuildConfiguration, {locator: locator});
};
...
TeamCityAPI.prototype.moveProject = function (locator, newParent) {
  ...
  return request.execute(projectEndpoints.moveProject, {locator: locator, parent: newParent});
};
...
TeamCityAPI.prototype.deleteProject = function (locator) {
  ...
  return request.execute(projectEndpoints.deleteProject, {locator: locator})
};
...
TeamCityAPI.prototype.deleteVcsRoot = function (id) {
  var self = this
    , request = self._request
    ;
...
TeamCityAPI.prototype.attachVcsRoot = function (buildLocator, vcsRootId) {
  var self = this
    , request = self._request
    ;

  return request.execute(buildConfigurationEndpoints.addVcsRoot, {locator: buildLocator, id: vcsRootId});
};

TeamCityAPI.prototype.detachVcsRoot = function (buildLocator, vcsRootId) {
  var self = this
    , request = self._request
    ;

  return request.execute(buildConfigurationEndpoints.removeVcsRoot, {locator: buildLocator, vcsRootIdLocator: vcsRootId});
};

TeamCityAPI.prototype.getBuildConfigurationVcsRoots = function (buildLocator) {
  var self = this
    , request = self._request
    ;

  return request.execute(buildConfigurationEndpoints.getVcsRoots, {locator: buildLocator});
};
