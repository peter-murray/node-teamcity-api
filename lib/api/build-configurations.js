...
BuildConfigurations.prototype.getTriggers = function (locator) {
  return this._request.execute(buildConfigurationEndpoints.getTriggers, {locator: locator});
};

BuildConfigurations.prototype.setTriggers = function(locator, triggers) {
  return this._request.execute(buildConfigurationEndpoints.setTriggers, {locator: locator, triggers: triggers});
};
