...
BuildConfigurations.prototype.detachVcsRoot = function (locator, vcsRootId) {
  return this._request.execute(buildConfigurationEndpoints.removeVcsRoot, {
    locator: locator,
    vcsRootIdLocator: vcsRootId
  });
};
...
BuildConfigurations.prototype.attachTemplate = function (locator, templateLocator) {
  return this._request.execute(buildConfigurationEndpoints.setTemplateAssociation, {
    locator: locator,
    templateId: templateLocator
  });
};
...
function protoTypeSubSetting(settingsType, singular, plural) {
  ...
  BuildConfigurations.prototype['delete' + singular] = function (locator, settingId) {
    return this._request.execute(buildConfigurationEndpoints['delete' + singular], {
      locator: locator,
      settingId: settingId
    });
  };
  ...
  BuildConfigurations.prototype['disable' + singular] = function (locator, settingId) {
    return this._request.execute(buildConfigurationEndpoints['disable' + singular], {
      locator: locator,
      settingId: settingId,
      disabled: true
    });
  ...
  BuildConfigurations.prototype['is' + singular + 'Disabled'] = function (locator, settingId) {
    return this._request.execute(buildConfigurationEndpoints['is' + singular + 'Disabled'], {
      locator: locator,
      settingId: settingId
    });
  };
