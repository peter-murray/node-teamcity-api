...
Projects.prototype.copy = function (name, id, parentId, sourceId) {
  return this._request.execute(projectEndpoints.copyProject, {name: name, id: id, parentId: parentId || constants.ROOT_PROJECT_LOCATOR.id, sourceId: sourceId})
};
